...
We first thought of creating a multiplayer game, but then we decided to create a messenger service instead, as we didn't want to be blocked by the typical hurdles of game development.

The project is *(fully)* documented on our [GitBook](https://heast.gitbook.io/docs/).

![Screenshot](heast-messenger/heast-messenger.png)
