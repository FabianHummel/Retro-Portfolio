...
Sky's Horizon is all about exploration and survival whilst accompanied by a story that is being told through the protagonist Chance, who is played by you. I try to keep a good ratio between freedom and story driven design, where the player is pointed into the right direction to progress further, but isn't forced to play along at all times.

This project is one of my few dream games of my life, and has been hunting me since the last few years. It has been through so many iterations using different game engines and concepts, but none of them seemed to be the right one. The history can be viewed [here](#/book/skys-horizon/history/minecraft.md).
